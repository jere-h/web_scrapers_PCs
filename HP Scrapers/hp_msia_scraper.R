...
# HP Product Scraper Type 1 (for Malaysia site)

# Set source folder as working directory
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))

pagelist0 <- read.delim("hp_msia_urls.txt", stringsAsFactor=F, header=F)
...
write.csv(compiled, "hp_msia_products.csv", row.names=FALSE)
